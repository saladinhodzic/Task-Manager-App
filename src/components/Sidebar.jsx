...
export default function Sidebar({ addNewProject, projects, selectProject }) {
  return (
    <aside className="bg-stone-900 text-stone-50 rounded-r-md py-6 px-8 w-1/3 md:w-72">
      ...
      <ul className="mt-8">
        {projects.map((project) => {
          let classes =
            "bg-stone-700 w-full text-left rounded-sm text-stone-300 px-3 py-2 hover:bg-stone-500 hover:text-stone-50";
